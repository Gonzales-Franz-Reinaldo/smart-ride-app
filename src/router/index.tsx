...
import PassengerTripsPage from '../pages/pasajero/PassengerTripsPage';
import PassengerRidesPage from '../pages/pasajero/PassengerRidesPage';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Paneles por rol */}
        <Route path="/pasajero" element={<PassengerTripsPage />} />
        <Route path="/pasajero/viajes" element={<PassengerRidesPage />} />
